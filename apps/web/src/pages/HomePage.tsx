  ...
  return (
    <div className="max-w-7xl mx-auto py-12 px-4 sm:px-6 lg:px-8">
      <div className="text-center">
        <h1 className="text-4xl font-bold text-[var(--text)] sm:text-5xl md:text-6xl">
          Convoy Navigation Platform
        </h1>
        <p className="mt-3 max-w-md mx-auto text-base text-[var(--text2)] sm:text-lg md:mt-5 md:text-xl md:max-w-3xl">
          ...
          {isAuthenticated ? (
            ...
            <div className="sm:flex sm:space-x-4">
              ...
              <div className="mt-3 sm:mt-0">
                <Link
                  to="/login"
                  className="w-full flex items-center justify-center px-8 py-3 text-base font-medium rounded-lg text-[var(--primary)] transition-colors md:py-4 md:text-lg md:px-10 whitespace-nowrap"
